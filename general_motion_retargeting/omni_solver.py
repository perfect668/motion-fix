"""Geometry-agnostic standalone WholeBody Omni V4 solver."""
...
from .omni_solver_core import OmniSolverCore
...
class RootSE3Task(Task):
    """Full pelvis position/orientation gauge for the V4 solver."""
...
class WholeBodyV4(OmniSolverCore):
    """Omni core with optional MuJoCo scene-collision backend.
    ...
    def __init__(self, config_path: str | Path, terrain, environment_pool: np.ndarray, fps: float = 50.0, solver: str = "daqp") -> None:
        ...
        # Add orientation and direction stabilisation after core construction.
        ...
        # V4 may add generic body-surface channels.  Rebuild the task from
        ...
        if self.scene_collision is not None:
            ...
            # The core discovers every mesh in its model. In a combined model the
