"""Single-motion entry point for the independent WholeBody Omni GMR path."""
...
def main() -> None:
    ...
    print(f"Saved whole-body Omni GMR motion to {destination}")
