"""Retarget HoloSoMo position mocap with standalone Omni-first V4."""
...
def main(argv: list[str] | None = None, *, retargeter_cls=WholeBodyV4) -> None:
